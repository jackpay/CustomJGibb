...
public class Inferencer {	
	...
	protected int infSampling(int m, int n){
		System.out.println("Correct INFERENCER");
		...
		for (int k = 0; k < newModel.K; k++){			
			newModel.p[k] = (trnModel.nw[w][k] + newModel.nw[_w][k] + (newModel.beta * newModel.data.docs[m].getTfIdf(_w)))/(trnModel.nwsum[k] +  newModel.nwsum[k] + Vbeta) *
